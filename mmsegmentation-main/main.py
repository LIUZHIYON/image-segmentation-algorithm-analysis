...
class MWindow(QtWidgets.QMainWindow):
    ...
    def setupUI(self):
        ...
        self.setWindowTitle('煤矿井下场景 mmseg 演示')
    ...
    def load_mmseg_model(self, model_name):
        ...
        if model_name == "deeplabv3+":
            ...
            checkpoint_file = 'checkpoint/pspnet_r18-d8_512x1024_80k_cityscapes_20201225_021458-09ffa746 (1).pth'
        else:
    ...
    def startCamera(self):
        """启动摄像头"""
        self.cap = cv2.VideoCapture(0, cv2.CCAP_DSHOW)
        if not self.cap.isOpened():
            print("1号摄像头不能打开")
            return
    ...
    def openImageFile(self):
        ...
        if imagePath:
            ...
            img_treated = show_result_pyplot(self.mmseg_models[self.current_model], img, result, opacity=0.5)
    ...
    def frameAnalyzeThreadFunc(self):
        ...
        while True:
            ...
            img = show_result_pyplot(self.mmseg_models[self.current_model], frame, result, opacity=0.5)
