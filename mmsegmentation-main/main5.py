...
class MWindow(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        # 启动处理帧的线程
        self.executor = ThreadPoolExecutor(max_workers=1)  # 单线程推理
    ...
    def load_mmseg_model(self, model_name):
        ...
        if model_name == "deeplabv3+":
            ...
            checkpoint_file = 'work_dirs/ZihaoDataset-DeepLabV3plus/best_mIoU_iter_9700.pth'
        elif model_name == "pspnet":
            config_file = 'Zihao-Configs/ZihaoDataset_PSPNet_20230818.py'
            checkpoint_file = 'work_dirs/ZihaoDataset-PSPNet/best_mIoU_iter_10300.pth'
        else:
            raise ValueError(f"未知的模型名称: {model_name}")

        model = init_model(config_file, checkpoint_file, device='cuda')  # 使用 GPU
    ...
    def visualize_result(self, img, result):
        ...
        palette = self.mmseg_models[self.current_model].PALETTE
        ...
        classes = self.mmseg_models[self.current_model].CLASSES
    ...
    def frameAnalyzeThreadFunc(self):
        ...
        while True:
            ...
            future.add_done_callback(self.on_frame_processed)
    ...
    def on_frame_processed(self, future):
        """帧处理完成后的回调"""
